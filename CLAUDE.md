...
- **G2（Auth/Vault/Policy/Audit）已从纯规则推进到真实 OIDC/SAML 网络/FFI 竖切**，四条判据（§24 G2）逐条如实：
  ...
  **W-1/W-2 已闭合**既有 schema/repository 地基；**W-3a/W-3b/W-4/W-6/W-7a/W-7b/W-7c**证据保持。Batch 11 后 G2 专项仍 **155/79/234**；Batch12–49新增面不改变该四元组。当前 tests **372/675/1047**、env **49/25/74**、events **33/53/86**、tables **58/0**、API **66/103/169**、components **8/14/22**、routes **8/24/32**、UI **87/65/152**、整个 parity **681/1005/1686**，fixtures **17/22/39**。R64–R68固定G3 data/realtime/migration；R69–R112固定Agent/G4与GUI批次及未完成边界。仍未闭合三家trace、acting Approval完整集成、run-wide budget、Desktop Local OAuth、MCP admin/private-egress、完整AG-UI事件、用户创建Agent lifecycle、完整channel/home Composer/AppSidebar、Refused sandbox共用、component admin UI与sandbox renderer、GUI/golden/Tauri binary/window与经许可legacy drills。**其它未闭合项**：G4余项/G5/G7、G2外审/KMS/Windows、G6/G8（R52–R112）。
...
- v3 §28.1 当前 **112** 条（R1–R112）。实施时除既有安全/G2裁决外，必须读R61–R112：既有Linux/数据库/Agent/GUI裁决，以及reviewed Connected Accounts、compiled manifest/PG治理、Quote+Cards+Charts+Activity Gallery、component runtime授权、受控data read、ordinary component durable conversation、Activity follow-up exact retry、Decisions durable/runtime/renderer与sandboxed后端原子治理；AppSidebar/完整Composer/Refused sandbox共用/admin UI/sandbox renderer/golden/经许可legacy drills仍未完成。
