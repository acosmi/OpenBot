...
- v3 §28.1 当前 **81** 条（R1–R81）。实施时除既有安全/G2 裁决外，必须读 R61–R81：Linux 历史证据、0016–0021、Actions manual-only、native thread/live/history/memory/run runtime/importer、Rust Agent、三 provider、retry/token/audit、tool loop/remember、remote AG-UI/双凭据、RMCP、Server OAuth、Google Drive REST、durable approval、Leptos/Axum GUI、偏好/Tauri target graph 与20条原语及各自未完成边界。
...
- Batch 15–18 已完成 Web 地基、Approval 可点击竖切、Server/Desktop 偏好、opt-in Tauri
  custom protocol adapter 与16个新增闭合原语；UI ledger 只勾有机器证据的 20 条。浏览器
