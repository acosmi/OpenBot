...
- **实施真源（后端）**：[OpenBot 全量 Rust 重写：终版研究、前置审计与实施方案](docs/2026-08-21-OpenBot全量Rust重写终版研究与实施方案.md)（v4 = v3 就地修订至 §28.1 R126，2026-08-29；R115–R125 是范围/参考源/Engine阶段裁决，R126 是 macOS P1 protocol/fuses/SBPL 实施裁决，实施前必读）
