...
- **实施真源（后端）**：[OpenBot 全量 Rust 重写：终版研究、前置审计与实施方案](docs/2026-08-21-OpenBot全量Rust重写终版研究与实施方案.md)
- **实施真源（GUI）**：[GUI 设计系统与视觉规格](docs/2026-08-22-OpenBot-GUI设计系统与视觉规格-方案.md)
