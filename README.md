...
- **实施真源（后端）**：[OpenBot 全量 Rust 重写：终版研究、前置审计与实施方案](docs/2026-08-21-OpenBot全量Rust重写终版研究与实施方案.md)（v4 = v3 就地修订至 §28.1 R185，2026-09-04；R115–R125 是范围/参考源/Engine阶段裁决，R126–R185 是后续实施裁决，实施前必读；R180覆盖RMCP旧wire，R182固定Golden分界，R183–R185固定CDP pure/live、正式screencast与Screen余项分界）
