...
### 15.1 当前实施勾选（2026-08-25，Batch 15–21）
...
- [x] 当前 UI ledger 只勾有机器证据的 24 条：Batch18 前20条 + Dialog/Sheet + Menu +
  MessageScroller，=`24/128/152`；其余即使有局部源码也保持 todo；
...
- [ ] 31 route journey、其余 3 个 primitive ledger 条目、45 个业务组件、compiled gallery、
