...
当前总台账（`cargo xtask parity-check` 复算）：parity **709/1694 done（985 todo）**，fixtures **17/39 done（22 todo）**；v4 overlay carry/revalidate/split/superseded = **1570/122/2/0**。勾选只表示整项判据已经通过；局部代码存在但整关未闭合时不得勾整关。
