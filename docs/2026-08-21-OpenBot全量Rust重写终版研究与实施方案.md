...
- [ ] **G6**：整关未通过；以下 Web GUI 地基已有本机机械证据：
  ...
  - [x] tokens.toml 单源生成 CSS/Rust、Inter 4.1 随包、74 项 icon manifest/SVG 双向闭合；i18n en/zh-CN 670 叶键及占位符 exact；WASM gzip/CSS/fonts 与零内联脚本预算绿；
...
当前总台账（`cargo xtask parity-check` 复算）：parity **701/1694 done（993 todo）**，fixtures **17/39 done（22 todo）**；v4 overlay carry/revalidate/split/superseded = **1594/98/2/0**。勾选只表示整项判据已经通过；局部代码存在但整关未闭合时不得勾整关。
