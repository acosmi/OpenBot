...
- [ ] **G2**：整关未通过；以下子项已经有本机机械证据：
  ...
  - [x] W-5 batch 1–5：identity / People / Audit / Policy durability+fanout+管理写面 / tool transcript projection；G2 队列当前 **111 done / 123 todo / 234 total**；
...
当前总台账：parity **213/1645 done（1432 todo）**，fixtures **9/31 done（22 todo）**。勾选只表示整项判据已经通过；局部代码存在但整关未闭合时不得勾整关。
